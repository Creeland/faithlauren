...
import { createGallery, type GalleryState } from "@/app/actions/gallery"
...
export default function NewGalleryPage() {
  ...
  return (
    <div className="max-w-lg">
      <h1 className="text-2xl font-light tracking-tight mb-8">New Gallery</h1>
      ...
      <form action={action} className="space-y-4">
        ...
        <p className="text-xs text-stone-500">
          A unique password will be auto-generated for client access.
        </p>
